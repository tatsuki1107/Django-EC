...
class Items(models.Model):
    ...
    company_id = models.ForeignKey("Companies", on_delete=models.CASCADE, null=False)
    populality = models.IntegerField()
    class Meta:
        db_table="items"
...
class Likes(models.Model):
    ...
    class Meta:
        db_table="likes"
        constraints = [
            models.UniqueConstraint(fields=["user_id", "item_id"], name="user_like_item")
        ]
